...
public class ImagePreprocessor {
    ...
    public ImagePreprocessor() {
        this.croppedBitmap = Bitmap.createBitmap(IMAGE_SIZE, IMAGE_SIZE,
                Config.ARGB_8888);
        this.rgbFrameBitmap = Bitmap.createBitmap(DoorbellCamera.IMAGE_WIDTH,
                DoorbellCamera.IMAGE_HEIGHT, Config.ARGB_8888);
    }
